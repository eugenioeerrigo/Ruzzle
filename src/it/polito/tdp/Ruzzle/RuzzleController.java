...
public class RuzzleController {
	...
	private Map<Pos,Button> letters ;          //mappa che mette in corrispondenza le celle nelle posizioni Pos con i bottoni
    ...
    void initialize() {
        ...
        assert btnProva != null : "fx:id=\"btnProva\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let00 != null : "fx:id=\"let00\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let01 != null : "fx:id=\"let01\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let02 != null : "fx:id=\"let02\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let03 != null : "fx:id=\"let03\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let10 != null : "fx:id=\"let10\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let11 != null : "fx:id=\"let11\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let12 != null : "fx:id=\"let12\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let13 != null : "fx:id=\"let13\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let20 != null : "fx:id=\"let20\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let21 != null : "fx:id=\"let21\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let22 != null : "fx:id=\"let22\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let23 != null : "fx:id=\"let23\" was not injected: check your FXML file 'Ruzzle.fxml'.";
        assert let30 != null : "fx:id=\"let30\" was not injected: check your FXML file 'Ruzzle.fxml'.";
